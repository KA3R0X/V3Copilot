...
Use this when you want to open V3 Copilot from another device (phone, tablet, another laptop).

## CLI ↔ Env option map

The V3 Copilot CLI accepts the following configuration options, available either as CLI flags or environment variables:
