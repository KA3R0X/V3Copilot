...
export const ProviderModelOptions = Schema.Struct({
  ...
  copilot: Schema.optional(CodexModelOptions), // Copilot uses same options as Codex
...
export const MODEL_OPTIONS_BY_PROVIDER = {
  ...
  copilot: [
    // Copilot models are fetched dynamically from the Copilot SDK
  ],
  claudeAgent: [
...
export const DEFAULT_MODEL_BY_PROVIDER: Record<ProviderKind, ModelSlug> = {
  codex: "gpt-5.4",
  copilot: "gpt-5.4", // Default for copilot; actual models come from SDK
...
export const REASONING_EFFORT_OPTIONS_BY_PROVIDER = {
  ...
  copilot: CODEX_REASONING_EFFORT_OPTIONS, // Copilot uses same reasoning options as Codex
